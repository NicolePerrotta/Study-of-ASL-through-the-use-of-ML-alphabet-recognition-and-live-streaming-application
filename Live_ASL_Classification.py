...
#print(classes, end = " ")
#print('\n')
loaded_model = tf.keras.models.load_model(r"C:\Users\perro\OneDrive\Desktop\model_8_75InceptionV3")
...
def doWork():
    ...
    while True:
        ...
        if ret:
            ...
            image_data = cv2.resize(img_cropped, (75,75))
