...
#print(classes, end = " ")
#print('\n')
loaded_model = tf.keras.models.load_model(r"C:\Users\perro\OneDrive\Desktop\model_8_75Inceptionv3_inverted")
...
def doWork():
    ...
    while True:
        ...
        if ret:
            ...
            img_croppedinverted = PIL.ImageOps.invert(img_croppedBW)
            
            img_croppedBW = np.asarray(img_croppedinverted) #becomes an array
            image_data = cv2.resize(img_croppedBW, (75,75))
